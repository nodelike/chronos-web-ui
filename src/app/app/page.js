            ...
            <div className="flex-1 p-8 pb-20 gap-8 sm:p-12">
                <main className="max-w-5xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {/* Dashboard Cards */}
                        <div className="bg-white rounded-lg shadow p-6 border border-gray-200 dark:border-gray-700">
                        ...
                        <div className="bg-white rounded-lg shadow p-6 border border-gray-200 dark:border-gray-700">
                            ...
                            <p className="text-gray-600 mb-4">Manage your profile settings and account preferences here.</p>
                            <div className="flex justify-end">
